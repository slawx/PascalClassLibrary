...
type
  ...
  private
    ...
    procedure PrintData(Data: TByteArray; Count: Integer; StringList: TStrings);
...
procedure TMainForm.PrintData(Data: TByteArray; Count: Integer; StringList: TStrings);
var
  I: Integer;
  B: Integer;
  OneByte: Byte;
...
begin
  ...
  for I := 0 to High(Data) do begin
    ...
    for B := 0 to 7 do begin
      ...
      Line := Line + Symbols[(OneByte shr B) and 1];
    end;
  end;
  StringList.Add(Line);
  //StringList.Add('');
...
begin
  ...
  for I := 0 to Stream.Size - 1 do begin
    ...
    for B := 0 to 7 do
      Line := Line + Symbols[(Data shr B) and 1];
  end;
  StringList.Add(Line);
  StringList.Add('');
end;
...
begin
  ...
  for I := 0 to Stream.Size - 1 do
    Line := Line + Symbols[Integer(Stream.ReadBit)];
  StringList.Add(Line);
  //StringList.Add('');
end;
