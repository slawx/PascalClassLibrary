...
procedure Register;
begin
  {$I bgralabel_icon.lrs}
  RegisterComponents('BGRA Controls', [TBGRALabel]);
  RegisterPropertyEditor(TypeInfo(TTranslateString), TBGRALabel,
    'Caption', TStringMultilinePropertyEditor);
end;
