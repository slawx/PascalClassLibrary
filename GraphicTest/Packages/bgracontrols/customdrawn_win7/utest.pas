...
uses
  ...
  { BGRABitmap }
  BGRAVirtualScreen, BGRABitmap, BGRABitmapTypes, BGRASamples,
...
begin
  ...
  if win7.folder = 'aero' + pathdelim then
    win7.folder := 'aerolite' + pathdelim
  else if win7.folder = 'aerolite' + pathdelim then
    win7.folder := 'luna' + pathdelim
  else if win7.folder = 'luna' + pathdelim then
    win7.folder := 'extra' + pathdelim
  else if win7.folder = 'extra' + pathdelim then
    win7.folder := 'aero' + pathdelim
  else
    win7.folder := 'aero' + pathdelim;
